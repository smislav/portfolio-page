const portfolio: Portfolio = {
    'about': {
        ...
        'about': 'I like to do interesting projects in different technologies in my free time',
    ...
    'experience': [
        ...
        },
        {
            ...
            'endDate': '2023',
            'name': 'Shake',
            'desc': 'Working as an mobile developer in multiple technologies like Android, React Native and Flutter. Involved in React dashboard and Python backend development. Leading the team.',
    ...
    'projects': [
        {
            'name': 'Portfolioo',
            'desc': 'Fast porftolio builder app creted in Next.js ',
            'link': 'https://portfolioo.page'
        },
        {
            'name': 'Blogspace',
            'desc': 'Minimalistic blogging app created with Flutter',
            'link': 'https://play.google.com/store/apps/details?id=com.blogspace&hl=en_US'
        },
        {
            'name': 'Quiz game',
            'desc': 'Chat GPT powered quiz game build with Flutter',
